        ...
        <div className="flex justify-center">
            <div className="border-2 p-6 rounded-lg">
                <div data-aos="zoom-in-up"
                    ...
                    className="card card-compact w-96 rounded-lg bg-gray-50">
                    ...
                    <div className="card-body">
                        ...
                        <div className="card-actions justify-end">
                            <Link to={`/jobApply/${_id}`}><button className="btn btn-primary hover:bg-slate-900 hover:shadow-2xl">Apply Now</button></Link>
                        </div>
                    </div>
                </div>
            </div>
